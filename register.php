...
$invalidbranch=false;
 ...
 if(isset($_POST['register'])){
   ...
   $query = "insert into user value(null,'$fname', '$lname','$email','$password', '$branch')";
  ...
  confirmButtonText: 'Login'
   ...
   text: 'Emai is Already Exist',
    ...
    if($invalidbranch){
     ...
     icon: 'error',
   title: 'Oops..',
   text: 'Please Chose A Valid Branch',
})</script>";
    }
     ?>
    <!-- Header code -->
